                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: 0;">
                    ...
                    <div class="nav-item dropdown " >
                        ...
                        <ul class="dropdown-menu  dropdown-menu-dark "id="dropwdownRevision" style="margin: 0;">
                            ...
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/aplicaciones/nueva"><i class="ms-lg-0 ms-2 bi bi-plus-circle me-2"></i>Solicitud de matrimonio</a>
                            </li>
                            <li>
...
<div class="row mb-3">
  <div class="col text-center "  style="margin: 40px auto;">
    <h1>Solicitudes Electronicas</h1>
  </div>
</div>
