...
<form class="border bg-light p-4 mt-4 mx-auto w-75" id="formularioAdministracion" name="formularioAdminitracion"
            ...
            <div class="modal-body">
                <form class="border bg-light p-5" id="formularioEvento">
                    ...
                    <div class="row justify-content-around mb-4">
                        ...
                        <div class="row justify-content-around mb-4">
                            <div class="col-lg-6">
                                ...
                                <select name="pco_cmbv" id="pco_cmbv" class="form-control" required>
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="pco_just" id="pco_just" class="form-control"
                                    placeholder="Escriba la justificación de su requerimiento" required>
                            </div>
                        </div>
                        <div class="row justify-content-around mb-4">
                            <div class="col-lg-6">
                                ...
                                <input value="<?php echo date('Y-m-d H:i') ?>" id="pco_fechainicio"
                                    name="pco_fechainicio" class="form-control" type="datetime-local" required>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="row justify-content-around mb-4">
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="pco_dir" id="pco_dir" class="form-control"
                                    placeholder="Escriba la dirección de la actividad" required>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="row justify-content-center mt-4 mb-4">
                        <div class="col-lg-4">
                            <button type="button" id="btnModificarEvento" name="btnModificarEvento"
...
<div class="modal fade modal-xl" id="modalSalCorrecciones" tabindroleex="-1" role="dialog"
    aria-labelledby="modalSalCorreccionesLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="border bg-light p-4" id="formularioSalidapais" name="formularioSalidapais"
                    ...
                    <div id="divSalidas">
                        ...
                        <div class="row justify-content-around mb-4">
                            <div class="col-lg-6">
                                ...
                                <input value="<?php echo date('Y/m/d H:i') ?>" id="ste_fecha2" name="ste_fecha2"
                                    class="form-control" type="datetime" placeholder="Fecha de la solicitud" disabled>
                        ...
                        <div class="row justify-content-center mt-12 mb-4" style="margin-top: 20px;">
                            <div class="col-lg-2">
                                <button type="button" id="modificarSalidas" name="modificarSalidas"
                ...
                <div class="modal-footer">
                    <button type="button" id="cerrarModal" class="btn btn-danger W-40"
...
<div class="modal fade modal-xl" id="modalProtoCorrecciones" tabindex="-1" role="dialog"
    aria-labelledby="modalProtoCorreccionesLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            </div>
            <div class="modal-body">
                <form class="border bg-light p-4" id="formularioProto" name="formularioProto" style="min-height: 50vh;">
                    <div id="Protocolo">
                        ...
                        <div class="row justify-content-center mt-12 mb-4" style="margin-top: 20px;">
                            <div class="col-lg-2">
                                <button type="button" id="modificarProtocolo" name="modificarProtocolo"
                                    class="btn btn-outline-warning w-100 overflow-visible text-wrap">Modificar</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="pdf">
                        ...
                        <div class="row justify-content-center mt-12 mb-4" style="margin-top: 20px;">
                            <div class="col-lg-6">
                                <button type="button" id="pdfProtocolo" name="pdfProtocolo"
                                    class="btn btn-outline-primary w-100 overflow-visible text-wrap">Guardar</button>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade modal-xl" id="modalCorrecionLicencias" tabindex="-1" role="dialog"
    aria-labelledby="modalCorrecionLicenciasLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            </div>
                ...
                <form class="border bg-light p-4" id="formularioLicenciasB" name="formularioLicenciasB"
                    ...
                    <div id="licencias">
                        ...
                        <div class="row justify-content-around mb-4">
                            ...
                            <div class="row justify-content-around mb-4">
                                <div class="col-lg-6">
                                    <label for="ste_fecha2"><i class="bi bi-calendar-date-fill"></i>Fecha de la
                                        Solicitud</label>
                                    <input value="<?php echo date('Y/m/d H:i') ?>" id="ste_fecha" name="ste_fecha"
                                ...
                                <div class="col-lg-6">
                                    <label for="ste_telefono"><i
                                            class="bi bi-telephone-inbound-fill"></i>Teléfono</label>
                                    <input value="" id="ste_telefono" name="ste_telefono" class="form-control"
                                        type="number" placeholder="Número telefónico">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <label for="sol_motivo"><i class="bi bi-journal-check"></i>Motivos</label>
                        ...
                        <div class="row justify-content-center mt-12 mb-4" style="margin-top: 20px;">
                            <div class="col-lg-2">
                                <button type="button" id="modificarLicencia" name="modificarLicencia"
                                    class="btn btn-outline-warning w-100 overflow-visible text-wrap">Modificar</button>
                            </div>
                        </div>
                    </div>
            ...
            <div id="divPdfLicencia">
                ...
                <div class="row justify-content-center mt-12 mb-4" style="margin-top: 20px;">
                    <div class="col-lg-6">
                        <button type="button" id="pdfLicencias" name="pdfLicencias"
                            class="btn btn-outline-primary w-100 overflow-visible text-wrap">Guardar</button>
                    </div>
                </div>
            </div>
...
<div class="modal fade modal-xl " id="modalCorreccionCasamiento" tabindex="-1" role="dialog"
    aria-labelledby="modalCorreccionCasamientoLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            </div>
                ...
                <form class="border bg-light p-4" id="formularioCasamiento" name="formularioCasamiento"
                    ...
                    <div class="row justify-content-center mt-12 mb-4">
                        <div class="col-lg-4 mt-12 mb-4">
                            <button type="click" id="btnModificaCasamiento" name="btnModificaCasamiento"
...
<div class="modal fade modal-md" id="modalPdfCorreccionCasamiento" tabindex="-1" role="dialog"
    aria-labelledby="modalPdfCorreccionCasamientoLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            </div>
            <div class="modal-body">
                <form class="border bg-light p-4" id="formularioPdf" name="formularioPdf" style="min-height: 50vh;">
                    ...
                    <div class="row justify-content-around mb-4">
                        ...
                        <div class="col-lg-12">
                            <label for="pdf_ruta"><i class="bi bi-file-pdf-fill"></i>Documentos PDF</label>
                            <input value="" id="catalogo" name="catalogo" class="form-control" type="text"
                                placeholder="Número de catálogo">
                            <input value="" id="pdf_id" name="pdf_id" class="form-control" type="hidden">
                            <input value="" id="pdf_solicitud" name="pdf_solicitud" class="form-control" type="hidden">
                            <input value="" id="pdf_ruta" name="pdf_ruta" class="form-control" type="file">
                        ...
                        <div class="row justify-content-center mt-12 mb-4" style="margin-top: 20px;">
                            <div class="col-lg-6">
                                <button type="button" id="modificarPdfCas" name="modificarPdfCas"
                                    class="btn btn-outline-primary w-100 overflow-visible text-wrap">Guardar</button>
                            </div>
                        </div>
                    </div>
