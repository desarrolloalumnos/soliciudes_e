            ...
            <div class="col-lg-10">
                <div id="carouselProtocolo" class="carousel slide">
                    <div class="carousel-indicators">
                        <button type="button" class="bg-dark active" data-bs-target="#carouselProtocolo"
                    ...
                    <!-- Diapositiva 1 -->
                    <div class="carousel-inner border bg-light p-5" id="formularioProtocolo" style="min-height: 50vh;">
                        <div class="carousel-item active">
                            ...
                            <div class="row justify-content-around mb-4">
                                ...
                                <div class="col-lg-6">
                                    <input value="text" id="mat_autorizacion" name="mat_autorizacion"
                            ...
                            <div class="row justify-content-around mb-4">
                                ...
                                <div class="col-lg-6">
                                    <input class="form-control"
                                        placeholder="Si el motivo es la opción 'OTROS' llene la observación"
                                        type="hidden" name="sol_obs" id="sol_obs" rows="10" cols="50">
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-around mb-4">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input value="" id="aut_fecha" name="aut_fecha" class="form-control"
                                        type="datetime-local">
                                </div>
                            </div>
                        </div>
                ...
                <div class="carousel-inner border bg-light p-5" id="formularioProtocolo" style="min-height: 50vh;">
                    ...
                    <div class="row justify-content-center mt-12 mb-4">
                        <div class="col-lg-2">
                            <button type="button" id="btnGuardar" name="btnGuardar" data-bs-target="#carouselProtocolo"
                                class="btn btn-outline-primary w-100">Guardar</button>
                        </div>
                        <div class="col-lg-2">
                            <button type="button" id="btnBuscar" name="btnBuscar" data-bs-target="#carouselProtocolo"
                                class="btn btn-outline-info w-100">Buscar</button>
                        </div>
                        <div class="col-lg-2">
                            <button type="button" id="btnModificar" name="btnModificar"
                                data-bs-target="#carouselProtocolo"
