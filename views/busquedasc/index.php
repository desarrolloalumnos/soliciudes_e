<form class="border bg-light p-4 mt-4 mx-auto w-75" id="formularioMatrimonio" name="formularioMatrimonio"
    ...
    <div class="row justify-content-center">
        <div class="col-lg-2">
            <button type="button" id="btnBuscar" name="btnBuscar" data-bs-target="#carouselMatrimonio"
...
<div class="modal fade modal-xl " id="modalM" tabindex="-1" role="dialog" aria-labelledby="modalMLabel"
    aria-hidden="true">
                ...
                <form class="border bg-light p-4" id="formularioCasamiento" name="formularioCasamiento"
                    ...
                    <div class="row justify-content-around mb-4">
                        <div class="col-lg-6">
                            ...
                            <input value="<?php echo date('d/m/Y H:i') ?>" id="ste_fecha" name="ste_fecha"
...
<div class="modal fade modal-md" id="modalPdf" tabindex="-1" role="dialog" aria-labelledby="modalPdfLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form class="border bg-light p-4" id="formularioPdf" name="formularioPdf" style="min-height: 50vh;">
                    ...
                    <div class="row justify-content-around mb-4">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input value="" id="catalogo" name="catalogo" class="form-control" type="hidden"
                                placeholder="Número de catálogo">
