...
<!-- <div class="position-absolute" style="top: 0; left: 0; max-width: 1000px; margin: 10px col-md-6;">
    <div id='calendar'></div>
</div> -->
...
<div class="modal fade modal-lg" id="modalProtocolo" tabindex="-1" role="dialog" aria-labelledby="modalProtocoloLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="border bg-light p-4" id="formularioProto" name="formularioProto"
                    ...
                    <div class="row justify-content-around mb-4">
                        ...
                        <div class="row justify-content-around mb-4">
                            <div class="col-lg-6">
                                <label for="pco_fechainicio">Fecha de inicio</label>
                                <input value="" id="pco_fechainicio" name="pco_fechainicio" class="form-control"
                                    type="date">
                            </div>
                            <div class="col-lg-6">
                                <label for="pco_fechafin">Fecha de finalización</label>
                        ...
                        <div class="row justify-content-center mt-12 mb-4">
                            <div class="col-lg-12">
                                <label for="pco_fechainicio"><i class="bi bi-file-pdf-fill"></i>Documentos PDF</label>
