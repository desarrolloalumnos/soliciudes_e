...
<form class="border bg-light p-4 mt-4 mx-auto w-75" id="formularioProtocolo" name="formularioProtocolo" style="min-height: 30vh; margin-top: 60px;">
    ...
    <div class="row mb-4">
        <div class="col-lg-6">
            ...
            <input id="ste_cat" name="ste_cat" class="form-control" type="number" placeholder="Número de catálogo" required>
        </div>
        <div class="col-lg-6">
            <label for="ste_fecha" class="form-label"><i class="bi bi-calendar-date-fill"></i> Fecha de la Solicitud</label>
    ...
    <div class="row justify-content-center mb-4">
        ...
        <div class="col-lg-4">
            <button type="button" id="btnCalendario" name="btnCalendario" class="btn btn-info w-100">Ver Calendario</button>
        </div>
    </div>
</form>
            ...
            <div class="modal-body">
                <form class="border bg-light p-5" id="formularioEvento">
                    ...
                    <div class="row justify-content-around mb-4">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input id="ste_cat" name="ste_cat" class="form-control" type="number" placeholder="Número de catálogo" disabled>
                    ...
                    <div class="row justify-content-around mb-4">
                        <div class="col-lg-6">
                            ...
                            <input value="<?php echo date('Y-m-d H:i')?>" id="ste_fecha" name="ste_fecha" class="form-control" type="datetime-local" disabled>
                        </div>
                        <div class="col-lg-6">
                            <label for="ste_telefono"><i class="bi bi-telephone-inbound-fill"></i> Teléfono</label>
                            <input id="ste_telefono" name="ste_telefono" class="form-control" type="number" placeholder="Número telefónico" disabled>
                        </div>
                    </div>
                ...
                <div class="row justify-content-around mb-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <textarea class="form-control"  id="sol_obs" name="sol_obs" placeholder="Ingrese sus obserciones, si no tiene, colocar SIN OBSERVACION" disabled></textarea>
                    </div>
                </div>
                ...
                <div class="row justify-content-around mb-4">
                    ...
                    <div class="row justify-content-around mb-4">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="pco_just" id="pco_just" class="form-control" placeholder="Escriba la justificación de su requerimiento" disabled>
                        </div>
                    </div>
                    <div class="row justify-content-around mb-4">
                        <div class="col-lg-6">
                            <label for="pco_fechainicio"><i class="bi bi-calendar-date-fill"></i>Fecha de inicio</label>
                            <input value="<?php echo date('Y-m-d H:i')?>" id="pco_fechainicio" name="pco_fechainicio" class="form-control" type="datetime-local" disabled>
                        </div>
                        <div class="col-lg-6">
                            <label for="pco_fechafin"><i class="bi bi-calendar-date-fill"></i>Fecha de finalización</label>
                            <input value="<?php echo date('Y-m-d H:i')?>" id="pco_fechafin" name="pco_fechafin" class="form-control" type="datetime-local" disabled>
                        </div>
                    </div>
                    <div class="row justify-content-around mb-4">
                        <div class="col-lg-6">
                            <label for="pco_dir"><i class="bi bi-geo-fill"></i>Dirección de actividad:</label>
                            <input type="text" name="pco_dir" id="pco_dir" class="form-control" placeholder="Escriba la dirección de la actividad" disabled>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                    <iframe id="pdfSalidaEvento" title="PDF" class="text-center" width="100%" height="500px" src=""></iframe>
                    </div>
                </div>
                        ...
                        <div class="row justify-content-around mb-4">
                            <div class="col-lg-6">
                                <label for="ste_fecha2"><i class="bi bi-calendar-date-fill"></i>Fecha de
                                    Solicitud</label>
                                <input value="<?php echo date('Y/m/d H:i')?>" value="" id="ste_fecha2" name="ste_fecha2" class="form-control" type="datetime">
                            </div>
                            <div class="col-lg-6">
                                <label for="ste_telefono"><i class="bi bi-telephone-inbound-fill"></i>Teléfono</label>
