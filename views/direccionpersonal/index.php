                    ...
                    <div id="divSalidas">
                        ...
                        <div class="row justify-content-around mb-4">
                            <div class="col-lg-6">
                                ...
                                <input value="<?php echo date('Y/m/d H:i')?>"id="ste_fecha2" name="ste_fecha2" class="form-control" type="datetime" disabled>
                    ...
                    <div id="Protocolo">
                        ...
                        <div class="row justify-content-around mb-4">
                            <div class="col-lg-6">
                                ...
                                <input value="<?php echo date('Y/m/d')?>" id="pco_fechainicio" name="pco_fechainicio" class="form-control" type="date">
                            </div>
                            <div class="col-lg-6">
                                <label for="pco_fechafin"><i class="bi bi-calendar-date-fill"></i>Fecha de  finalización</label>
                                <input value="<?php echo date('Y/m/d')?>" id="pco_fechafin" name="pco_fechafin" class="form-control" type="date">
                            </div>
                        </div>
                        <div class="row justify-content-around mb-4">
                            <div class="col-lg-6">
...
<div class="modal fade modal-xl " id="modalCasamiento" tabindex="-1" role="dialog" aria-labelledby="modalCasamientoLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            </div>
                ...
                <form class="border bg-light p-4" id="formularioCasamiento" name="formularioCasamiento" style="min-height: 50vh;" enctype="multipart/form-data">
                    ...
                    <div class="row justify-content-around mb-4">
                        <div class="col-lg-6">
                            ...
                            <input value="<?php echo date('Y/m/d H:i')?>" id="ste_fecha" name="ste_fecha" class="form-control" type="datetime">
...
<div class="modal fade modal-xl" id="modalMostrarLicencias" tabindex="-1" role="dialog" aria-labelledby="modalMostrarLicenciasLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            </div>
