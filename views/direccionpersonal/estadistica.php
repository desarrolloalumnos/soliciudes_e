    ...
    <div class="container">
        ...
        <div class="row">
            <div class="card">
                ...
                <canvas id="chart2TopPaises"></canvas>
            </div>
            <div class="card">
                <h4>Oficiales con mas solicitudes</h4>
                <canvas id="chart2Top5"></canvas>
            </div>
            <div class="card">
                <h4>Top 5 comandos </h4>
                <canvas id="chart2Concurrencia"></canvas>
            </div>
            <div class="card">
                <h4>Tipos de Solicitudes</h4>
                <canvas id="chart2Motivos"></canvas>
            </div>
            <div class="card">
                <h4>Estados de Las Solicitudes</h4>
                <canvas id="chart2Estados"></canvas>
            </div>
