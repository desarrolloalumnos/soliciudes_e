...
<div class="modal fade modal-xl" id="modalMdnProto" tabindex="-1" role="dialog" aria-labelledby="modalMdnProtoLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            </div>
...
<div class="modal fade modal-xl " id="modalMdnCas" tabindex="-1" role="dialog" aria-labelledby="modalMdnCasLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            </div>
...
<div class="modal fade modal-xl" id="modalMdnLicencia" tabindex="-1" role="dialog" aria-labelledby="modalMdnLicenciaLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            </div>
...
<div class="modal fade modal-xl" id="modalMdnAceptar" tabindex="-1" role="dialog" aria-labelledby="modalMdnAceptarLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            </div>
            <div class="modal-body">
                <form class="border bg-light p-4" id="formularioValidar" name="formularioValidar" style="min-height: 50vh;">
                    ...
                    <div id="corregirRechazar">
                        ...
                        <div class="row justify-content-center mt-12 mt-4 mb-4">
                        <div class="col-lg-2">
                            <button id="guardarRechazado" name="guardarRechazado" class="btn btn-primary">Guardar</button>
                        </div>
                    </div>
                    </div>                  
                </form>
